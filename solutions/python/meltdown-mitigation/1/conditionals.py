...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    Note:
            ...
            """
    temperature_and_neutrons_ps = temperature * neutrons_produced_per_second
    ninety_percent_threshold = (threshold * (90 / 100))
    if temperature_and_neutrons_ps < ninety_percent_threshold:
        return "LOW"
    if 0.9 * threshold <= temperature_and_neutrons_ps <= 1.1 * threshold:
        return "NORMAL"
    return "DANGER"
